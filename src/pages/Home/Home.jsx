...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-[1000px] mx-auto pt-[30px] md:pt-[50px] flex  bg-[#fff] dark:bg-[#000]">
        <div className="py-[20px] w-[80%] idi:mx-auto md:w-full">
          <div className="stories w-[90%] px-[10px] sm:w-full mx-auto relative overflow-x-scroll flex items-center gap-x-[20px]">
            <History title="milord__007" image={person} />
            <History title="milord__007" image={person} />
            <History title="milord__007" image={person} />
            <History title="milord__007" image={person} />
            <History title="milord__007" image={person} />
            ...
            <div className="flex items-center justify-between">
              ...
              <Stack direction="row" spacing={1}>
                ...
                <div className="flex flex-col leading-[18px]">
                  ...
                  <h1 className="text-[#A8A8A8] text-[14px]">milord__007</h1>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-y-[10px]">  
              <div className="flex items-center justify-between">
                ...
                <Stack direction="row" spacing={1}>
                  ...
                  <div className="flex flex-col leading-[18px]">
                    <h1 className="text-[#000] dark:text-[#000]">milord__007</h1>
      ...
      >
        <DialogContent
          className="w-[800px] xl:w-[800px] lg:max-w-[700px] md:max-w-full bg-[#fff] dark:bg-[#000]"
          sx={{
            padding: 0,
          }}
        >
